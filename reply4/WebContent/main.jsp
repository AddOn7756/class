...
<div class="content">
	...
	<ol>
		<li><a href="control.jsp?action=main">로고</a></li>
...
<a href="control.jsp?action=main&mcnt=${mcnt+1}&selUser=${selUser1}">더보기&gt;&gt;</a>
...
<ol>
	<c:forEach var="u" items="${newUsers}">
		<li><a href="control.jsp?action=main&mcnt=${mcnt}&selUser=${u.memid}">${u.name}</a>님 가입</li>
	</c:forEach>
</ol>
